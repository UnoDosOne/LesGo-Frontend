...
const RecordsTable = () => {
  const initialRecords = [
    ...
    {
      formType: "Permit to Study",
      dateToAttend: "05-08-2024",
      timeToAttend: "02:00 PM",
      received: false,
    },
    {
      formType: "Rush Fee",
      dateToAttend: "06-08-2024",
      timeToAttend: "03:00 PM",
      received: false,
    },
    {
      formType: "Correction of Name",
      dateToAttend: "07-08-2024",
  ...
  const handleReschedule = (index) => {
    ...
    updatedRecords[index].received = true;
  ...
  const filteredRecords = records.filter((record) => {
    const recordDate = new Date(record.dateToAttend);
    ...
    return (
      ...
      (receivedFilter === "" ||
        (receivedFilter === "received" && record.received) ||
        (receivedFilter === "not_received" && !record.received))
    );
  });
          ...
          <tbody className="divide-y divide-gray-200">
            {currentRecords.map((record, index) => (
              <tr key={index} className="hover:bg-gray-50">
                ...
                <td className="px-4 md:px-6 py-4 whitespace-nowrap text-sm md:text-base">
                  {record.dateToAttend} || {record.timeToAttend}
                </td>
                <td className="px-4 md:px-6 py-4">
                  {record.received ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-2 md:px-3 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800 hover:bg-red-200 transition"
                    >
