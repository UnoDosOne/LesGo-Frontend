...
const Login = ({ setRegister }) => {
	...
	useEffect(() => {
		if (btnSubmit) {
			if (form.userType) {
				navigate('/' + form.userType + '/queue/'); // Adjust based on your route structure
			}
		}
	}, [btnSubmit, navigate]);
	...
	const handleForgotPasswordClick = () => {
		navigate('/forgot-password'); // Change this to the correct path if necessary
	};

	// Trigger form submission
	const onSubmitClick = () => {
		handleSubmit(); // Run validation and backend login
	};
